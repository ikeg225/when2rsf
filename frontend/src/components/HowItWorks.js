const HowItWorks = () => {
    return(
        <div>
            ...
            <p>Our predictive models are built using Scikit-learn and Keras for neural networks. These models undergo rigorous training on the cleaned dataset. We experiment with different algorithms to determine the most accurate approach for predicting RSF capacity percentages based on time, weather, school events, and other influential factors.</p>
